...
export function AdminAiCoachChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hi! I'm your Admin Intelligence AI. I can help you analyze your workforce data, identify talent risks, and review assessment completion trends. What would you like to know?",
    },
  ]);
  ...
  async function initializeCoach() {
    ...
    try {
      const res = await fetch("/api/admin/ai-coach", {
        method: "GET",
        cache: "no-store",
      });
      ...
      <AnimatePresence>
        {!open && (
          ...
          >
            ...
            <span className="text-sm font-medium">Data Insights AI</span>
          </motion.button>
        )}
      </AnimatePresence>
          ...
          >
            <div className="ai-aurora-bg relative flex items-center gap-3 border-b border-white/10 px-4 py-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold text-white/95">Admin Intelligence AI</p>
                <p className="text-[10px] text-cyan-400/80">Analyzes live organizational data</p>
              </div>
              <button
                type="button"
                onClick={() => void toggleOpen()}
